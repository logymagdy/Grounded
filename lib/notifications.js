...
import Constants from 'expo-constants' // 👈 Added to get Project ID
...
export async function registerForPushNotificationsAsync() {
  ...
  // We MUST provide the projectId from app.json/app.config.js
  // Source: https://docs.expo.dev/push-notifications/push-notifications-setup/#get-the-push-token
  try {
    const projectId = 
    ...
    const token = (await Notifications.getExpoPushTokenAsync({
      projectId: projectId, // 👈 This is required for Expo Go
    })).data
